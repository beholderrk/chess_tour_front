...
angular.module('chessTourFrontApp').directive('chAutocomplete', ['$parse', '$http', '$sce', '$timeout', function ($parse, $http, $sce, $timeout) {
    var KEY_DW = 40,
        KEY_UP = 38,
        KEY_ES = 27,
        KEY_EN = 13,
    ...
    return {
        ...
        link: function(scope, elem, attrs) {
            ...
            var callOrAssign = function(value) {
                if (typeof scope.handleSelectedObject === 'function'){
                    scope.handleSelectedObject(value, scope.selectedObject);
                } else {
